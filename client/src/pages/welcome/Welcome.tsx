...
const Welcome = (props: Props) => {
  ...
  const submitForm = async (passwordActivate: {
    ...
    try {
      await dispatch(userActions.welcome(passwordActivate));
  ...
  return (
    <PageContainer name="welcome">
      ...
      <div id="welcome-form-container" className="welcome-form-container">
        <div className="row">
          <div className="col-md-4 offset-md-4">
            <h4 id="welcome-form-header" className="welcome-form-header text-center">
              Create your password
            </h4>
            {tokenInputProps.errorMessage || serverErrors.status === HttpStatus.UNAUTHORIZED ? (
              <div
                id="welcome-form-token-error"
                className="welcome-form-token-error alert alert-danger fade show"
                role="alert">
            ...
            <Form name={formName} handleSubmit={formik.handleSubmit}>
              ...
              <div className="text-center">
                <button
                  id="welcome-form-submit"
                  className="btn btn-primary welcome-form-submit p-0"
                  type="submit"
                  tabIndex={3}
